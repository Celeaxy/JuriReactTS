...
import {
  newline as newlineToken, eof, newlineEmpty, newlineBracketed, indent, dedent, 
  ParenthesizedExpression,ArgList, ParamList,
  ParenL, BracketL
} from "./juri.terms.js"
...
export const trackIndent = new ContextTracker({
  ...
  shift(context, term, stack, input) {
    ...
    if (term == ParenL || term == BracketL ) return new IndentLevel(context, -1)
    return context
  },
